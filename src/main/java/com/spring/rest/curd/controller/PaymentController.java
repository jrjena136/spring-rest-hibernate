...
public class PaymentController {
	...
	@PostMapping("/payNow")
	public PaymentResponse payIntant(@RequestBody Payment payment){
		return service.doPayment(payment);
	}
	@GetMapping("/transactions/{vendor}")
	public PaymentResponse getTransactionByVendor(@PathVariable String vendor){
		return service.getAllTransaction(vendor);
	}
